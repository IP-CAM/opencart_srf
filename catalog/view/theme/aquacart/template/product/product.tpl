...
<div id="content" class="inside_page"><?php echo $content_top; ?>
  ...
  <div class="product-info">
    ...
    <div class="left">
      <?php if ($thumb) { ?>
      <div class="image"><div class="image_inside"><a href="<?php echo $popup; ?>" title="<?php echo $heading_title; ?>" class='cloud-zoom' id='zoom1' rel="tint: '#ffffff',tintOpacity:0.5 ,smoothMove:3,zoomWidth:380, zoomHeight:380, adjustY:-6, adjustX:<?php echo ($this->language->get('direction')=='rtl' ? '-710' : '25');?>"><img src="<?php echo $thumb; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" id="image" /></a></div><?php if ($special) { ?><div class="special_promo"></div><?php } ?></div>
